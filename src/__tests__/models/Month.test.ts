...
describe("Month", () => {
  ...
  it("Generates correct string", () => {
    expect(Month.toJSON(Month.January)).toEqual("0")
    expect(Month.toJSON(Month.February)).toEqual("1")
    expect(Month.toJSON(Month.March)).toEqual("2")
    expect(Month.toJSON(Month.April)).toEqual("3")
    expect(Month.toJSON(Month.May)).toEqual("4")
    expect(Month.toJSON(Month.June)).toEqual("5")
    expect(Month.toJSON(Month.July)).toEqual("6")
    expect(Month.toJSON(Month.August)).toEqual("7")
    expect(Month.toJSON(Month.September)).toEqual("8")
    expect(Month.toJSON(Month.October)).toEqual("9")
    expect(Month.toJSON(Month.November)).toEqual("10")
    expect(Month.toJSON(Month.December)).toEqual("11")
  })
})
