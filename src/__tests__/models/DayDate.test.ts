...
describe("DayDate", () => {
  ...
  it("Generates correct string", () => {
    expect(DayDate.toString({ day: 1, month: Month.January, year: 2019 })).toEqual("01-01-2019")
    expect(DayDate.toString({ day: 20, month: Month.February, year: 1983 })).toEqual("20-02-1983")
    expect(DayDate.toString({ day: 29, month: Month.February, year: 2016 })).toEqual("29-02-2016")
    expect(DayDate.toString({ day: 15, month: Month.October, year: 2500 })).toEqual("15-10-2500")
    expect(DayDate.toString({ day: 31, month: Month.December, year: 2016 })).toEqual("31-12-2016")
    expect(DayDate.toString({ day: 4, month: Month.April, year: 1000 })).toEqual("04-04-1000")
  })
})
